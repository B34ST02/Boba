...
echo color("red","   =====================================\n");
echo color("red","  |  Auto Create Gojek X Redeem Gofood  |\n");
echo color("red","  |     Thank's To Wisnu. Sender 1RP    |\n");
echo color("red","  |     Hidup Di Dunia Hanya Sekali     |\n");
echo             "  |  Author By : Ade Daffa Mahendra     |\n";
